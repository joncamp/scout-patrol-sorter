...
3. **Map columns** — the tool auto-detects name/email/unit/gender/birth date; override if needed. Set the **course start date** (used to determine who is 18+ during the event) and tweak the tenting gap (days), patrol size, and per-unit options.
...
5. **Export CSV** or **Print** the results.
